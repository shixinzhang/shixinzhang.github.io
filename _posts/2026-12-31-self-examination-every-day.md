...
![](https://img-blog.csdn.net/20180730015504313)
...
1.早会没讲什么特殊的，前端有个妹子专门负责我们这边的需求，后面得记得叫她。

上午解决了一个问题，小黄人问题原来不是偶现，是必现的。**重视问题，在可能出现问题的地方加上日志，看日志后再决定是否能解决。**

2.中午问了下 lp 才知道复盘会原来不是他主持，是我来，慌得一批。

简单写了点 PPT，中午眯了下脑子里也一直在想这个，赶紧爬起来继续准备材料。

今天复盘会参加的人好多，讲了做的功能，效果没有说，因为没来得及看数据。

还讲了些流程方面的问题，这个占用的时间比较长，会上承诺出要做几个表格，明天就得弄出来，贴到每个需求前面。

讲完流程，zsr 提了一个问题：**复盘了半天，数据在哪里。**

这个问题真的打脸哈哈，的确复盘得用数据说话，不然没有价值。

后来快结束时， syq 跟我说等下 ty。然后这段时间回顾了一下运营的一些活动数据。
...
可以学习一下,避免长篇大论讨论流程问题. 角度更高,针对做的事复盘.


3.复盘会收获

1. 开这种大会前，确定是谁主持，自己主持的话，提前做准备，没准备好宁愿不开！
2. 时间太久了，后面大家都在看手机发呆，效率低下
3. 复盘的目的是知道情况，需要数据支撑，提前找产品运营要一下
4. 这种大会，需要等老大在再开

4.晚上和小肉聊天

1. 丈母娘问什么时候结婚
2. 小肉说养孩子的成本,需要上各种兴趣班\补习班,一个月至少一万多
3. 买房
...
1.今天感触比较大的是 wy 拿到腾讯的 offer，知道这个消息时心里有些酸溜溜的，羡慕嫉妒的情绪涌了上来。开始质疑自己现在的选择究竟对不对。

最后和肉肉聊了聊，发现自己真的是眼界太小了，也不相信上帝，只知道抱怨和贪婪。

求主原谅，让我能够踏实的走，剩下的交给主，一切都是最好的安排。

当然**前提是自己不负好时光！**

2.早上《半小时漫画中国史》看到第十三话。

站会确认了各个需求的时间，月中应该是没问题。月底的需求需要这周确定了，不然服务端都要被分去做别的业务了。
...
下午花了两三个小时看长按没触发响应的问题，修改代码怎么没生效呢？

修改 xml 不生效，最后发现是有两个同名的。。。 另外那个在业务相关目录下，可能先用了那个

3.回顾下直播需求迭代历史
http://wiki.ximalaya.com/pages/viewpage.action?pageId=8685530

如何一步步走到现在的

佟帅总结的 roadmap: https://mubu.com/doc/C6rRoJGFi

4.Java中为什么静态方法不能被重写

https://blog.csdn.net/dawn_after_dark/article/details/74357049

5.人在穷的时候，要少在家里玩，不如出去外边接触世界
...
1.今天上班时路上看了差不多一章《半小时漫画中国史》，主要讲了秦朝为大一统做的一些改个，和他的衰落。

扶苏本来是太子，和蒙恬一起守边疆。结果秦始皇突然死亡，留在身边的胡亥和赵高篡位。

总共四十多章，要读完得多加油了。

2.站会前画了下大白板，听王敏意见，小白板写里程碑。里程碑还是有价值的，我不确定该先做哪个时，看下需求的先后顺序，就知道了。
...
1. 非诚勿扰需求被 ty 拍回去了，需要重新写方案
2. 服务端人手空闲，估计是被安排做其他业务了。。。
3. 方向不确定，不完善基本功能，直接做相亲，不知道运营效果如何

cy 不在，别人不确定测试进度。这个时候就看出来是否主动了，如果一把手不在的情况下，你能 hold 住场面。那你就是后备一把手。要主动了解全局，不是只关心自己做的那部分。

3.中午吃饭时感觉大家兴致不是很高，可能是因为假期还没休息过来吧。

4.下午有一些小事，心里有些乱，休息久了工作状态还没回来吧。四点多才开始写代码。艾特写的差不多了，之前没做的长按复制内容，有个事件冲突，明天解决下。

js 今天感觉很努力，向他学习！

5.晚上下班的时候碰到了 ty，我是往下他往上，第一反应是想绕道而走，转念一想有些好笑。

为什么还不好意思下班呢？是哪种心态在作怪？

完成好任务就行了，难道必须得十点下班才心安吗？还得要生活！

6.晚上回家路上听了极客时间《即时通讯技术》的一节，在 processon 上画了脑图。

越来越感觉脑图的好处了，让人方便组织知识。

没忍住多画了个几个脑图的开始，后面逐渐完善把！！

7.最近学什么，还是有些纠结

一步步来吧，先把 groovy 弄完，再学后端。
...
3.问心会会议纪要（钰琪整理）：
https://shimo.im/docs/VY9qWXYT8Pc8gtgH/

语音房公会和流量数据分析（启明、钰琪整理）：
https://shimo.im/slides/PRdJCHdd9XwQJT66/
...
1.[三年，足以完成从双非到互联网大厂的跳跃](https://mp.weixin.qq.com/s/LxOHVm_Po83EYG469X-5eA)
...
第一点是**缺乏和你的沟通**，应该定期向你汇报团队这一段时间里的运转状况和遇到的问题。即使有些问题我要自己解决，也需要把解决方案和你说下，你可能有更好的建议。

第二点是**没有重视问题的严重性**。对已知的团队协调方面的问题，应该像你今天这样，尽快召开会议让大家抛出问题和讨论解决办法。之前我想的是等这个版本结束了找个时间一起探讨下迭代记录里的问题，但是涉及到整个团队的问题，应该要提高优先级，尽快解决才是。

第三点是**对需求排期的把控不足**。前面做的几个大需求，没有多和你聊确定哪些是真正重要的，前期合理规划需求排期，后面可能就不会出现这期遇到的，很多需求点同时开发、同时提测的问题，给测试同学这么大的压力。应该像你最近做的学习，根据优先级和工作量把需求拆分成不同的点，分版本完成。应该从每个小的需求点开始，而不是说从下期需求再开始。

第四点是**缺乏周期性的反省**。比如站会、日报这种，虽然有使用白板等改进，但改进的太慢了，应该避免习惯性的做一些事，多思考还有没有可以提升的点。
